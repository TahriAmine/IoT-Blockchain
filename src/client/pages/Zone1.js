...
const Welcome =()=>{
  ...
  const [dataH2, setDataH2]= useState([]);
...
<table className='table table-borderless'>
  ...
  return(
    <div>
        <h1 className='text-center'>Data IoT Zone 1</h1>
